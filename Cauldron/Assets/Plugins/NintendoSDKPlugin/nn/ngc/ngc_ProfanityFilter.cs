...
namespace nn.ngc
{
    public sealed partial class ProfanityFilter : IDisposable
    {
        ...
        {
            NoOption = 0,
            UnicodeNormalization = 1 << 0,
            SimilarForm = 1 << 1,

            [Obsolete("This member is obsoleted. Use NoOption instead")]
            NormalizationOption_NoOption = 0,
            [Obsolete("This member is obsoleted. Use UnicodeNormalization instead")]
            NormalizationOption_UnicodeNormalization = (1 << 0),
            [Obsolete("This member is obsoleted. Use SimilarForm instead")]
