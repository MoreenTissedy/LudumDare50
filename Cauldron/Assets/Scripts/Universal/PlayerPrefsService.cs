namespace Universal {
    public static class PlayerPrefsService {
        ...
        public static bool GetBool(string key, bool defaultValue = false) => UnityEngine.PlayerPrefs.GetInt(key, defaultValue ? 1 : 0) != 0;

        public static float GetFloat(string key, float defaultValue = 0f) => UnityEngine.PlayerPrefs.GetFloat(key, defaultValue);
